...
module TelestreamCloud::Notifications
  ...
  class Topic
    ...
    def valid?
      service_validator = EnumAttributeValidator.new('String', ["qc"])
      return false unless service_validator.valid?(@service)
      event_validator = EnumAttributeValidator.new('String', ["video-passed", "video-error", "video-warning", "video-rejected", "video-canceled"])
    ...
    def service=(service)
      validator = EnumAttributeValidator.new('String', ["qc"])
    ...
    def event=(event)
      validator = EnumAttributeValidator.new('String', ["video-passed", "video-error", "video-warning", "video-rejected", "video-canceled"])
    ...
    def hash
      [account, service, event, project].hash
    end
    ...
    def _deserialize(type, value)
      ...
      when /\AHash<(?<k_type>.+?), (?<v_type>.+)>\z/
        ...
        temp_model = TelestreamCloud::Notifications.const_get(type).new
