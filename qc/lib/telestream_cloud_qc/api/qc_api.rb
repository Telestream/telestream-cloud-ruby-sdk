...
module TelestreamCloud::Qc
  class QcApi
    ...
    # @return [nil]
    def cancel_job(project, job, opts = {})
      cancel_job_with_http_info(project, job, opts)
      return nil
    end
    ...
    def cancel_job_with_http_info(project, job, opts = {})
      ...
      if @api_client.config.client_side_validation && project.nil?
        fail ArgumentError, "Missing the required parameter 'project' when calling QcApi.cancel_job"
      end
      # verify the required parameter 'job' is set
      if @api_client.config.client_side_validation && job.nil?
        fail ArgumentError, "Missing the required parameter 'job' when calling QcApi.cancel_job"
      end
      # resource path
      local_var_path = "/projects/{project}/jobs/{job}/cancel.json".sub('{' + 'project' + '}', project.to_s).sub('{' + 'job' + '}', job.to_s)
    ...
    # @param [Hash] opts the optional parameters
    # @return [Job]
    def create_job(project, data, opts = {})
      data, _status_code, _headers = create_job_with_http_info(project, data, opts)
      return data
    end
    ...
    def create_job_with_http_info(project, data, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: QcApi.create_job ..."
      end
      # verify the required parameter 'project' is set
      if @api_client.config.client_side_validation && project.nil?
        fail ArgumentError, "Missing the required parameter 'project' when calling QcApi.create_job"
      end
      ...
      # resource path
      local_var_path = "/projects/{project}/jobs.json".sub('{' + 'project' + '}', project.to_s)
    ...
    # @param [Hash] opts the optional parameters
    # @return [Job]
    def get_job(project, job, opts = {})
      data, _status_code, _headers = get_job_with_http_info(project, job, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Job, Fixnum, Hash)>] Job data, response status code and response headers
    def get_job_with_http_info(project, job, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: QcApi.get_job ..."
      end
      # verify the required parameter 'project' is set
      if @api_client.config.client_side_validation && project.nil?
        fail ArgumentError, "Missing the required parameter 'project' when calling QcApi.get_job"
      end
      # verify the required parameter 'job' is set
      if @api_client.config.client_side_validation && job.nil?
        fail ArgumentError, "Missing the required parameter 'job' when calling QcApi.get_job"
      end
      # resource path
      local_var_path = "/projects/{project}/jobs/{job}.json".sub('{' + 'project' + '}', project.to_s).sub('{' + 'job' + '}', job.to_s)
    ...
    # @param [Hash] opts the optional parameters
    # @return [Project]
    def get_project(project, opts = {})
      data, _status_code, _headers = get_project_with_http_info(project, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Project, Fixnum, Hash)>] Project data, response status code and response headers
    def get_project_with_http_info(project, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: QcApi.get_project ..."
      end
      # verify the required parameter 'project' is set
      if @api_client.config.client_side_validation && project.nil?
        fail ArgumentError, "Missing the required parameter 'project' when calling QcApi.get_project"
      end
      # resource path
      local_var_path = "/projects/{project}.json".sub('{' + 'project' + '}', project.to_s)
    ...
    def list_jobs(project, opts = {})
      data, _status_code, _headers = list_jobs_with_http_info(project, opts)
      return data
    end
    ...
    def list_jobs_with_http_info(project, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: QcApi.list_jobs ..."
      end
      # verify the required parameter 'project' is set
      if @api_client.config.client_side_validation && project.nil?
        fail ArgumentError, "Missing the required parameter 'project' when calling QcApi.list_jobs"
      end
      # resource path
      local_var_path = "/projects/{project}/jobs.json".sub('{' + 'project' + '}', project.to_s)
    ...
    # @return [Project]
    def modify_project(project, opts = {})
      data, _status_code, _headers = modify_project_with_http_info(project, opts)
      return data
    end
    ...
    # @option opts [Data1] :data 
    # @return [Array<(Project, Fixnum, Hash)>] Project data, response status code and response headers
    def modify_project_with_http_info(project, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: QcApi.modify_project ..."
      end
      # verify the required parameter 'project' is set
      if @api_client.config.client_side_validation && project.nil?
        fail ArgumentError, "Missing the required parameter 'project' when calling QcApi.modify_project"
      end
      # resource path
      local_var_path = "/projects/{project}.json".sub('{' + 'project' + '}', project.to_s)
    ...
    # @param [Hash] opts the optional parameters
    # @return [Proxy]
    def proxy(project, job, opts = {})
      data, _status_code, _headers = proxy_with_http_info(project, job, opts)
      return data
    end
    ...
    def proxy_with_http_info(project, job, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: QcApi.proxy ..."
      end
      # verify the required parameter 'project' is set
      if @api_client.config.client_side_validation && project.nil?
        fail ArgumentError, "Missing the required parameter 'project' when calling QcApi.proxy"
      end
      # verify the required parameter 'job' is set
      if @api_client.config.client_side_validation && job.nil?
        fail ArgumentError, "Missing the required parameter 'job' when calling QcApi.proxy"
      end
      # resource path
      local_var_path = "/projects/{project}/jobs/{job}/proxy.json".sub('{' + 'project' + '}', project.to_s).sub('{' + 'job' + '}', job.to_s)
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def remove_job(project, job, opts = {})
      remove_job_with_http_info(project, job, opts)
      return nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def remove_job_with_http_info(project, job, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: QcApi.remove_job ..."
      end
      # verify the required parameter 'project' is set
      if @api_client.config.client_side_validation && project.nil?
        fail ArgumentError, "Missing the required parameter 'project' when calling QcApi.remove_job"
      end
      # verify the required parameter 'job' is set
      if @api_client.config.client_side_validation && job.nil?
        fail ArgumentError, "Missing the required parameter 'job' when calling QcApi.remove_job"
      end
      # resource path
      local_var_path = "/projects/{project}/jobs/{job}.json".sub('{' + 'project' + '}', project.to_s).sub('{' + 'job' + '}', job.to_s)
    ...
    def remove_project(project, opts = {})
      remove_project_with_http_info(project, opts)
      return nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def remove_project_with_http_info(project, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: QcApi.remove_project ..."
      end
      # verify the required parameter 'project' is set
      if @api_client.config.client_side_validation && project.nil?
        fail ArgumentError, "Missing the required parameter 'project' when calling QcApi.remove_project"
      end
      # resource path
      local_var_path = "/projects/{project}.json".sub('{' + 'project' + '}', project.to_s)
    ...
    def signed_urls(project, job, opts = {})
      data, _status_code, _headers = signed_urls_with_http_info(project, job, opts)
      return data
    end
    ...
    def signed_urls_with_http_info(project, job, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: QcApi.signed_urls ..."
      end
      # verify the required parameter 'project' is set
      if @api_client.config.client_side_validation && project.nil?
        fail ArgumentError, "Missing the required parameter 'project' when calling QcApi.signed_urls"
      end
      # verify the required parameter 'job' is set
      if @api_client.config.client_side_validation && job.nil?
        fail ArgumentError, "Missing the required parameter 'job' when calling QcApi.signed_urls"
      end
      # resource path
      local_var_path = "/projects/{project}/jobs/{job}/signed-urls.json".sub('{' + 'project' + '}', project.to_s).sub('{' + 'job' + '}', job.to_s)
    ...
    def upload_video(project, video_upload_body, opts = {})
      data, _status_code, _headers = upload_video_with_http_info(project, video_upload_body, opts)
      return data
    end
    ...
    def upload_video_with_http_info(project, video_upload_body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: QcApi.upload_video ..."
      end
      # verify the required parameter 'project' is set
      if @api_client.config.client_side_validation && project.nil?
        fail ArgumentError, "Missing the required parameter 'project' when calling QcApi.upload_video"
      end
      ...
      # resource path
      local_var_path = "/projects/{project}/upload.json".sub('{' + 'project' + '}', project.to_s)
