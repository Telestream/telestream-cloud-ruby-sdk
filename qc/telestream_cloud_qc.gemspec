...
Gem::Specification.new do |s|
  s.name        = "telestream_cloud_qc"
  s.version     = TelestreamCloud::Qc::VERSION
  ...
  s.summary     = "Telestream Cloud Quality Control SDK"
  s.description = "Telestream Cloud Quality Control SDK"
