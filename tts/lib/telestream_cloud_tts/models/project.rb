...
module TelestreamCloud::Tts
  ...
  class Project
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'profanity_filter')
        self.profanity_filter = attributes[:'profanity_filter']
      end

      if attributes.has_key?(:'generate_proxy')
        self.generate_proxy = attributes[:'generate_proxy']
      end

      if attributes.has_key?(:'custom_words')
        self.custom_words = attributes[:'custom_words']
      end
    ...
    def valid?
      status_validator = EnumAttributeValidator.new('String', ["available", "modified", "training", "failed"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["available", "modified", "training", "failed"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          generate_proxy == o.generate_proxy &&
          custom_words == o.custom_words &&
    ...
    def hash
      [id, account_id, name, description, status, language, sample_rate, profanity_filter, generate_proxy, custom_words, created_at, updated_at].hash
    end
