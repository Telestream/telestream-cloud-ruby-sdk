...
module TelestreamCloud::Tts
  class TtsApi
    ...
    def delete_job_with_http_info(project_id, job_id, opts = {})
      ...
      # resource path
      local_var_path = "/projects/{projectID}/jobs/{jobID}".sub('{' + 'projectID' + '}', project_id.to_s).sub('{' + 'jobID' + '}', job_id.to_s)
    ...
    def job_result_with_http_info(project_id, job_id, opts = {})
      ...
      # resource path
      local_var_path = "/projects/{projectID}/jobs/{jobID}/result".sub('{' + 'projectID' + '}', project_id.to_s).sub('{' + 'jobID' + '}', job_id.to_s)
