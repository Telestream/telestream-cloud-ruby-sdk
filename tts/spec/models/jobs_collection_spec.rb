...
# Unit tests for TelestreamCloud::Tts::JobsCollection
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'JobsCollection' do
  before do
    # run before each test
    @instance = TelestreamCloud::Tts::JobsCollection.new
  end
  ...
  describe 'test an instance of JobsCollection' do
    it 'should create an instance of JobsCollection' do
      expect(@instance).to be_instance_of(TelestreamCloud::Tts::JobsCollection)
    end
  end
